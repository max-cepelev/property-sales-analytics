...
import { IFamalyMacroData, IMacroData, IMinipolisData } from './macro.entities';
import {
...
type Request = FastifyRequest<{
  Reply: MacroResponseType | { message: string };
}>;

export const macroService = plugin(
