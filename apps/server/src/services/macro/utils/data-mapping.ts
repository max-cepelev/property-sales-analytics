import { IMacroData, IMinipolisData } from '../macro.entities';
import { MacroResponseType } from '../macro.schema';
...
export const transformMacroData = (data: IMacroData[]): MacroResponseType => {
  const response = [];
...
export const transformMinipolis = (
  data: IMinipolisData[],
): MacroResponseType => {
