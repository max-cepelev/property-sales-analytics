...
export class BuildingSchemaBuilder {
  builder;
  ...
  getBuildingSchema() {
    return this.builder.prismaObject('Building', {
      fields: (t) => ({
        id: t.exposeInt('id'),
  ...
  getBuildingInput() {
    return this.builder.inputType('BuildingInput', {
      fields: (t) => ({
  ...
  getBuildingForMapSchema() {
    return this.builder.objectType(BuildingsForMapDto, {
      name: 'BuildingForMap',
      fields: (t) => ({
        id: t.exposeInt('id'),
        name: t.exposeString('name'),
